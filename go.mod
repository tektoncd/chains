...
// Replace pipeline with PR #9043 branch for OpenTelemetry migration
replace (
	...
	github.com/tektoncd/pipeline => github.com/khrm/pipeline v0.0.0-20260205141141-f8f832f42539
)
