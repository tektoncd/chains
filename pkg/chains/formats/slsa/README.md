...
|**slsa/v2alpha4**| **slsa v1.0**  | Extends v2alpha3 with StepAction-aware provenance: captures type-hinted StepAction results and the remote origin (URI + digest) of each step's definition. Use this format if your TaskRun steps reference remote StepActions via a resolver.|
