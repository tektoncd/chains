...
func createPro(path string) *objects.PipelineRunObjectV1Beta1 {
	...
	tr1, err := objectloader.TaskRunV1Beta1FromFile("../../../testdata/pipeline-v1beta1/taskrun1.json")
	if err != nil {
		panic(err)
	}
	tr2, err := objectloader.TaskRunV1Beta1FromFile("../../../testdata/pipeline-v1beta1/taskrun2.json")
	if err != nil {
		panic(err)
	}
...
func TestPipelineMaterials(t *testing.T) {
	...
	ctx := logtesting.TestContextWithLogger(t)
	got, err := PipelineMaterials(ctx, createPro("../../../testdata/pipeline-v1beta1/pipelinerun1.json"), &slsaconfig.SlsaConfig{DeepInspectionEnabled: false})
	if err != nil {
		t.Error(err)
	}
...
func TestStructuredResultPipelineMaterials(t *testing.T) {
	...
	ctx := logtesting.TestContextWithLogger(t)
	got, err := PipelineMaterials(ctx, createPro("../../../testdata/pipeline-v1beta1/pipelinerun_structured_results.json"), &slsaconfig.SlsaConfig{DeepInspectionEnabled: false})
	if err != nil {
