...
func NewConfigFromMap(data map[string]string) (*Config, error) {
	...
	if err := cm.Parse(data,
		...
		asStringSet(taskrunStorageKey, &cfg.Artifacts.TaskRuns.StorageBackend, "tekton", "oci", "gcs", "docdb"),
		...
		asStringSet(ociStorageKey, &cfg.Artifacts.OCI.StorageBackend, "tekton", "oci", "gcs", "docdb"),
